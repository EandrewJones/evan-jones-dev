...
function NavigationList() {
    ...
    return (
        <NavigationMenuList className="w-[200px] flex-col items-start ">
            {navLinks.map(link => {
                const activePath =
                    link.href === '/'
                        ? link.href === pathname
                ...
                return (
                    <NavigationMenuItem
                        ...
                        className={cn([
                            ...
                            {
                                'border-l-2 border-ring bg-primary/10':
                                    activePath,
...
export default function Navigation() {
    return (
        <NavigationMenu
            className="border-primary-outline flex-col border bg-card/40"
