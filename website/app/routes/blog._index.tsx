...
export default function Blog() {
    ...
    const matchingPosts = useMemo(() => {
        return filterDocuments<PostPreview>(data ?? [], query)
    }, [data, query])
    ...
    return (
        <>
            <p>
                Topics I commonly like to write about include LLMOps, learning
                new skills, DS{'&'}A, and projects I am working on. Everything
                else falls into a musings bucket.
            </p>
            <p>
                I prefer a published post over a perfect post, so think of them
                as parts of an on-going conversation. Ideas, like code bases,
                mature through continued practice and refactoring.
            </p>
            {data && !loading ? (
